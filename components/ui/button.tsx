...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = 'primary', size = 'md', children, disabled, ...props }, ref) => {
        ...
        const variants = {
            ...
            outline: 'border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 focus:ring-indigo-500 disabled:hover:bg-transparent',
            ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-gray-500 disabled:hover:bg-transparent disabled:text-gray-400',
